...
//source[v-model_01.js][javascript]{
new Vue({
  el: '#app',
  data: {
    text: ""
...
//source[v-model_02.js][javascript]{
new Vue({
  el: '#app',
  data: {
    text: ""
...
//source[v-model_03.js][javascript]{
new Vue({
  el: '#app',
  data: {
    checked: false
...
//source[v-model_04.js][javascript]{
new Vue({
  el: '#app',
  data: {
    checkedNames: []
...
//source[v-model_05.js][javascript]{
new Vue({
  el: '#app',
  data: {
    modulation: ""
...
//source[v-model_06.js][javascript]{
new Vue({
  el: '#app',
  data: {
    hisyo: ""
